<template>
  <div class="PointReward">
      ...
      <div class="ThemeBox_BottomText">
        <ul>
          <li>
            ...
            }}<img :src="IconPath(pointIcon)" alt="" />和闯关币<img
    ...
    >
      ...
      >
        ...
        <div v-else class="pointReward_tk_lottie">
          <PublicJson
            ...
            "
            :lottieJson="dialogData.goods_type == 'mic' ? hql : ch_csfl"
            :userAvatar="
      ...
      <p
        v-if="
          dialogData.type === 'lucky_key' || dialogData.type === 'pretty_card'
        "
      ...
      <DialogCounter
        v-if="
          dialogData.max_times !== 1 &&
          dialogData.type !== 'lucky_key' &&
          dialogData.type !== 'pretty_card'
        "
      ...
      <div class="Dialog_Buttons" v-if="showDialogButtons">
        <div class="left-button flex_across" @click="onExcharge(1)">
          <p>
            {{
              dialogData.goods_type === 'keys' ||
              dialogData.goods_type === 'pretty_card'
                ? '兑1个'
                : '兑换'
            }}
          </p>
