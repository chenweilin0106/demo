...
INSERT INTO "skills" ("id", "name", "description", "directory", "repo_owner", "repo_name", "repo_branch", "readme_url", "enabled_claude", "enabled_codex", "enabled_gemini", "enabled_opencode", "installed_at") VALUES ('github/awesome-copilot:skills\git-commit', 'git-commit', 'Execute git commit with conventional commit message analysis, intelligent staging, and message generation. Use when user asks to commit changes, create a git commit, or mentions "/commit". Supports: (1) Auto-detecting type and scope from changes, (2) Generating conventional commit messages from diff, (3) Interactive commit with optional type/scope/description overrides, (4) Intelligent file staging for logical grouping', 'git-commit', 'github', 'awesome-copilot', 'main', 'https://github.com/github/awesome-copilot/blob/main/skills/git-commit/SKILL.md', 0, 1, 0, 0, 1774315722);
COMMIT;
