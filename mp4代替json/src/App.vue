<template>
  <div>
    ...
    <button v-if="!vap" @click.stop="play(0)">play(无融合)</button>
    <button v-if="!vap" @click.stop="play(1)">play(有融合)</button>
...
import config from './components/demo.json'
export default {
  components: {},
  props: {},
  data() {
    return {
      access: true,
      url: require('./components/demo.mp4'),
      vap: null
    }
  },
  computed: {},
