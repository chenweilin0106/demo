    ...
    >
      <div class="bgc_horizontal_main">
                ...
                <div class="img-box">
                  <div class="img-top">
                    ...
                    <div v-else class="rsyj_lottie">
                      <PublicJson :jsonName="item.id == '4676' ? 'ch_rsyj_1' : 'ch_zfz1'" />
                    </div>
                  </div>
        ...
        <div
          ...
          :class="[ButtonStyle('1', rechargeAward.has_right), { RechargeLevel5000_Button: isSpecial(rechargeAward) }]"
...
import PublicJson from '@/pages/520/components/publicJson.vue'
