  ...
  <div class="imgCompo">
    ...
    <template v-else-if="imgPattern === 2">
      ...
      <div :class="['micAvatar', imgType == 'mic' ? 'micA' : imgType == 'voice' ? 'voiceA' : null]" v-if="imgType == 'mic' || imgType == 'voice'">
        <img :src="'https://cdn-image.dandan818.com/uploads/user/icon/201711/11351510221321.jpeg'" @error="imgAtError" />
      </div>
      <!-- svga容器 -->
...
export default {
  ...
  methods: {
    ...
    svgaFn(svgaName, id, loop = 0) {
      ...
      svga_parser.load(`http://h5.dev.dandanvoice.com/vue/test/${svgaName}`, (videoItem) => {
        svga_play.setVideoItem(videoItem)
        // svga_play.setText('Hello, World!', 'word')
        svga_play.setImage('https://cdn-image.dandan818.com/uploads/user/icon/201711/11351510221321.jpeg', 'pic_1')
        svga_play.setImage('https://cdn-image.dandan818.com/uploads/user/icon/201711/11351510221321.jpeg', 'pic_2')
        svga_play.setImage('https://cdn-image.dandan818.com/uploads/user/icon/201711/11351510221321.jpeg', 'pic_3')
