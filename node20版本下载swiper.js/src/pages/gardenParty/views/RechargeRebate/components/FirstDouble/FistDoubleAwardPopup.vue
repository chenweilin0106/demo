        ...
        <div class="awardsList flex justify-center align-center">
          <div v-for="(item, index) in firstDoubleAwardPopupData" :key="index" class="award">
            <div class="awardIcon position-relative">
              <img v-if="index == 1" :src="IconPath('tk_8.png')" class="firstLabel position-absolute" />
              <div v-else class="multipleLabel position-absolute line-height-100 text-nowrap">x{{ item.double_nums }}</div>
...
.smallContent {
  width: 522px;
  height: 523px;
  background-image: url('@/pages/gardenParty/assets/tk_9.png');
  .title {
    margin-top: -43px;
    background-image: url('@/pages/gardenParty/assets/tk_4.png');
  }
  .text {
    width: 556px;
    background-image: url('@/pages/gardenParty/assets/tk_6.png');
  }
  .awardText {
    color: #ffffff;
  }
...
.bigContent {
  ...
  width: 646px;
  height: 644px;
  background-image: url('@/pages/gardenParty/assets/tk_10.png');
  .title {
    margin-top: 26px;
    background-image: url('@/pages/gardenParty/assets/tk_5.png');
  }
  .text {
    width: 569px;
    background-image: url('@/pages/gardenParty/assets/tk_7.png');
  }
  .awardText {
    color: #e02424;
  }
