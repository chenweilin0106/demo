    ...
    <div class="inner">
      <div class="left-content flex flex-column">
        ...
        <div class="icon-content">
          ...
          <!-- json容器 -->
          <template v-else>
            <PublicJson v-if="exchargeItem.goods_type === 'title'" class="title" jsonName="ch_ymcf" />
            <PublicSvga v-else class="mic" svgaName="ts_yycg" :userAvatar="$store.state.user_icon" />
          </template>
          <!-- 锁定状态 -->
