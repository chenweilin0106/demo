...
.RechargeRebate {
  ...
  .rechargeAwards {
    ...
    border-image-slice: 104 0 52 0 fill; /*todo 顶部距离是一般tab高度 底部距离一般和outBox一致*/
    border-image-width: 104px 0 52px 0; /*todo 顶部距离是一般tab高度 底部距离一般和outBox一致*/
    border-image-source: url('@/pages/goldenAutumn/assets/zs_3.png'); /*todo 连续充值有礼背景*/
    ...
    .RechargeRebate_BottomBox_Tab {
      ...
      .resetIcon {
        ...
        width: 124px;
        height: 42px;
        background: url('@/pages/goldenAutumn/assets/mk2_1.png') no-repeat left top/100% 100%; /*todo 图片名 可能要改*/
      }
      .update-1 {
        position: absolute;
        ...
        width: 96px;
        height: 128px;
        background: url('@/pages/goldenAutumn/assets/mk2_5.png') no-repeat left top/100% 100%; /*todo 图片名 可能要改*/
      }
      .tab {
        position: relative;
        flex: 1;
  ...
  .active-tab-bg {
    border-image-source: url('@/pages/goldenAutumn/assets/zs_4.png'); /*todo 连续充值有礼边框背景图片名*/
  }
}
</style>
