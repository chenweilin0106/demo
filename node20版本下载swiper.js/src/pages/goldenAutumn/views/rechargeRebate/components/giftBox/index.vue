...
const CongratsGetPopup = () => import('@/pages/goldenAutumn/components/congratsGetPopup.vue') // 恭喜获得弹窗
...
.giftBox {
  ...
  background: url('@/pages/goldenAutumn/assets/mk2_12.png') no-repeat left top/100% 100%; /*todo 礼盒容器背景*/
