...
.rechargeTasksList {
  ...
  height: 126px; /*todo 卡片高度 不需要加上外圈描边宽度*/
  margin-bottom: 18px; /*todo 卡片底部间距*/
  border-radius: 9px; /*todo 卡片圆角*/
  display: flex;
  align-items: center;
      ...
      .PresentItem {
        ...
        .img-box {
          ...
          .img-bottom {
            ...
            background-color: #C94A32; /*todo 奖励文字背景色*/
          }
        }
        .update-text-2 {
          position: absolute;
