...
import TasksList from '@/pages/goldenAutumn/views/pointReward/components/tasksList.vue'
import ExchangeList from '@/pages/goldenAutumn/views/pointReward/components/exchangeList.vue'
import Jump2024 from '@/pages/goldenAutumn/views/pointReward/components/jump2024.vue'
const ExchangeGiftsPopup = () => import('@/pages/goldenAutumn/views/pointReward/popups/exchangeGiftsPopup.vue')
export default {
  name: 'pointReward',
  ...
  data() {
    return {
      ...
      goods_list: [
        ...
        { type: 'title', goods_name: '永久称号', goods_type: 'title', goods_id: 4987, goods_num: 0, price: 600, max_times: 1, goods_icon: 'ch_tsbf', goods_icon_t: 'ch_tsbf', goods_num_text: '永久称号+1', is_owned: false, is_lock: false, exchange_times: 0, has_right: 1 },
        ...
        { exchange_times: 0, goods_icon: 'zxsy_182_112.png', goods_icon_t: 'zxsy_182_112.png', goods_id: 80, goods_name: '众星闪耀', goods_num: 3, goods_num_text: '私聊气泡+3天', goods_type: 'chat_bubble', has_right: 1, is_lock: false, is_owned: false, max_times: 2, price: 45, price_text: '45', type: 'chat_bubble' },
      ...
      pointIcon: Object.freeze('fy_63_59.png'), // 道具图标
      pointName: Object.freeze('枫叶') // 道具名称
    }
  },
  computed: {
    taskListData() {
