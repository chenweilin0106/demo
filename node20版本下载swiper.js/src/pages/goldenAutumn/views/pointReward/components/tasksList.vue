...
.tasksList {
  .task-item {
    ...
    //background: url('@/pages/goldenAutumn/assets/mk1_3.png') no-repeat left top/100% 100%;
    ...
    .icon-content {
      ...
      border-radius: 16px;
      background-color: #D25E2A; /*todo 任务列表中道具边框颜色*/
      .icon {
        width: 100%;
        height: 68px;
        ...
        // 图片大小
        > img {
          width: 63px; /*todo 道具宽度*/
          height: 59px; /*todo 道具高度*/
        }
      }
      .text {
        flex: 1;
        ...
        white-space: nowrap;
        line-height: 100%;
        background-color: #B55023; /*todo 背景色*/
        color: #fff; /*todo 字体颜色*/
      }
    }
    .text-content {
