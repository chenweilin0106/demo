  ...
  <div class="storeCompo">
    <OutBox class="stockBox" :bottom="false">
      ...
      <div class="stockArea">
        <div class="stockItem" v-for="(item) in inventory_list" :key="item.id">
          ...
          <div :class="['priceMark', `status${item.currency}`]">
            <span>{{item.price}}</span>
            <img class="ybMark" v-if="item.currency == 'gamegold'" :src="IconPath('yb_43_27.png')" />
            <img class="zsMark" v-if="item.currency == 'masonry'" :src="IconPath('zs_27_20.png')" />
          </div>
          <div :class="['stockItemNum', item.stockNum==0?'noNum':null]">库存:&ensp;{{item.stockNum}}</div>
        </div>
      </div>
    </OutBox>
    ...
    <OutBox class="storeBox">
      ...
      <div class="turnCardArea">
        <TurnCard :gift_list="gift_list" @buyFn="buyFn" @getHomePage="getHomePage"></TurnCard>
      </div>
      <div class="axialArea">
        <div class="dollDiv">
...
export default {
  ...
  data() {
    return {
      ...
      inventory_list: [
        { id: 1, type: 'tool', icon: 'cbt_120_120.png', text: '戒指+1', currency: 'masonry', price: '26000', stockNum: 0 },
        { id: 2, type: 'tool', icon: 'cbt_120_120.png', text: '+1', currency: 'masonry', price: '6万', stockNum: 0 },
        { id: 3, type: 'tool', icon: 'cbt_120_120.png', text: '+1', currency: 'gamegold', price: '26000', stockNum: 300 },
        { id: 4, type: 'tool', icon: 'cbt_120_120.png', text: '座驾+3天', currency: 'gamegold', price: '55万', stockNum: 30 },
        { id: 5, type: 'tool', icon: 'cbt_120_120.png', text: '戒指+1', currency: 'gamegold', price: '100万', stockNum: 30 },
        { id: 6, type: 'tool', icon: 'cbt_120_120.png', text: '戒指+1', currency: 'gamegold', price: '26000', stockNum: 30 },
        { id: 7, type: 'tool', icon: 'cbt_120_120.png', text: '戒指+1', currency: 'gamegold', price: '26000', stockNum: 30 },
        { id: 8, type: 'tool', icon: 'cbt_120_120.png', text: '戒指+1', currency: 'gamegold', price: '26000', stockNum: 30 }
      ], // 库存列表
      swipeList: [], // 文字轮播
      property: {
        gamegold: 0,
...
.storeCompo{
  ...
  .storeBox{
    ...
    .textSwipeArea{
      width: 750px;
      height: 71px;
      background: url('@/pages/goldenAutumn/assets/mk4_5.png') no-repeat left top/100% 100%;
      margin-top: 10px;
      padding: 0 30px;
      position: relative;
      left: 50%;
    ...
    .axialArea{
      ...
      .dollDiv{
        width: 298px;
        height: 258px;
        background: url('@/pages/goldenAutumn/assets/mk4_6.png') no-repeat left top/100% 100%;
        position: absolute;
        left: -20px;
        bottom: 0;
        .dollDiscourse{
      ...
      .refreshBtn{
        ...
        top: 150px;
        &.status0{
          background: url('@/pages/goldenAutumn/assets/mk4_38.png') no-repeat left top/100% 100%;
        }
        &.status1{
          background: url('@/pages/goldenAutumn/assets/mk4_39.png') no-repeat left top/100% 100%;
        }
        &.status2{
          background: url('@/pages/goldenAutumn/assets/mk4_40.png') no-repeat left top/100% 100%;
        }
        .refreshPrice{
          font-weight: bold;
          font-size: 32px;
