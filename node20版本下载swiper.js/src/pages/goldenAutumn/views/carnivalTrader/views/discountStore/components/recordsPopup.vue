<template>
  <PopupBox :title="'title_13.png'" :size="3" @clickClose="clickClose">
    <div class="main" ref="scrollDiv" @scroll="handleScroll">
      ...
      <div class="listItem" v-for="(item, index) in list" :key="index">
        ...
        <div class="item2">{{item.discount_desc}}<img :src="IconPath(propertyIcon[item.type])" /></div>
        <div class="item3">{{item.voucher_desc}}</div>
        <div class="item4">{{item.price}}<img :src="IconPath(propertyIcon[item.type])" /></div>
      </div>
