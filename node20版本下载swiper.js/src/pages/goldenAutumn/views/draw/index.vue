...
import Marquee from '@/pages/goldenAutumn/components/marquee.vue'
  ...
  data() {
    return {
      ...
      marqueeData: [
        ...
        { icon: 'xmyl_120_120.png', text: '+1', name: '公屏气泡', type: 'chat_bubble_pub' },
        { icon: 'hdfclwsjzsq_120_120.png', text: '+1', name: '随机赠送权', type: 'tool' },
...
.drawPage{
  .travelBox{
    ...
    .topBg{
      ...
      z-index: 1;
      &.status1{
        background: url('@/pages/goldenAutumn/assets/mk4_5.png') no-repeat left bottom/100%;
      }
      &.status2{
        background: url('@/pages/goldenAutumn/assets/mk4_6.png') no-repeat left bottom/100%;
      }
      &.status3{
        background: url('@/pages/goldenAutumn/assets/mk4_7.png') no-repeat left bottom/100%;
      }
      .topPlaceBg{
        width: 720px;
        height: 250px;
        ...
        &.status1{
          background: url('@/pages/goldenAutumn/assets/mk4_1.png') no-repeat left top/100% 100%;
        }
        &.status2{
          background: url('@/pages/goldenAutumn/assets/mk4_2.png') no-repeat left top/100% 100%;
        }
        &.status3{
          background: url('@/pages/goldenAutumn/assets/mk4_3.png') no-repeat left top/100% 100%;
        }
      }
      .swipeDiv{
        width: 750px;
        height: 71px;
        background: url('@/pages/goldenAutumn/assets/mk4_4.png') no-repeat left top/100% 100%;
        margin: 0 auto;
      }
      .usedMasonryDiv{
      ...
      .serverTravelProgressDiv{
        ...
        .timesProgress{
          ...
          .scaleBg{
            width: 94px;
            height: 189px;
            background: url('@/pages/goldenAutumn/assets/mk4_30.png') no-repeat left top/100% 100%;
            position: absolute;
            left: 0px;
            top: 50%;
          ...
          .lightingBg{
            width: 110px;
            height: 366px;
            background: url('@/pages/goldenAutumn/assets/mk4_25.png') no-repeat left top/100% 100%;
            position: absolute;
            left: 50%;
            top: 66%;
      ...
      .vehicleDiv{
        ...
        z-index: -1;
        &.doubleBg{
          background: url('@/pages/goldenAutumn/assets/mk4_9.png') no-repeat left top/100% 100%;
        }
        .doubleTipBg{
          width: 750px;
          height: 607px;
          background: url('@/pages/goldenAutumn/assets/mk4_26.png') no-repeat left top/100% 100%;
          position: absolute;
          left: 50%;
          transform: translateX(-50%);
          top: 0px;
      ...
      .rulesBtn{
        width: 56px;
        height: 56px;
        background: url('@/pages/goldenAutumn/assets/mk2_2.png') no-repeat left top/100% 100%;
        position: absolute;
        right: 20px;
        top: 400px;
      }
      .recordBtn{
        width: 165px;
        height: 78px;
        background: url('@/pages/goldenAutumn/assets/mk4_27.png') no-repeat left top/100% 100%;
        position: absolute;
        left: 50%;
        transform: translateX(-50%);
        bottom: 300px;
      ...
      .darwBtns{
        ...
        .drawOneBtn{
          ...
          &.status2{
            background: url('@/pages/goldenAutumn/assets/mk4_10_1.png') no-repeat left top/100% 100%;
          }
        }
        .drawTenBtn{
          width: 245px;
          ...
          &.status2{
            background: url('@/pages/goldenAutumn/assets/mk4_11_1.png') no-repeat left top/100% 100%;
          }
        }
        .drawFiftyBtn{
          width: 245px;
          ...
          &.status2{
            background: url('@/pages/goldenAutumn/assets/mk4_12_1.png') no-repeat left top/100% 100%;
          }
        }
      }
    }
    .rewardsArea{
      ...
      .rewardsLeftCoverBg{
        width: 46px;
        height: 204px;
        background: url('@/pages/goldenAutumn/assets/mk4_14.png') no-repeat left top/100% 100%;
        position: absolute;
        left: 0;
        top: 50px;
        z-index: 2;
      ...
      .awardsMoveTip{
        width: 560px;
        height: 33px;
        background: url('@/pages/goldenAutumn/assets/mk4_13.png') no-repeat left top/100% 100%;
  ...
  .scenicSpotBox{
    ...
    .coinsBg{
      width: 656px;
      height: 274px;
      background: url('@/pages/goldenAutumn/assets/mk4_21.png') no-repeat left top/100% 100%;
      ...
      .coinItemBg{
        ...
        .conItemIcon{
          ...
          height: 100px;
          &.status1{
            background: url('@/pages/goldenAutumn/assets/tyscjnb_120_120.png') no-repeat left top/100% 100%;
          }
          &.status2{
            background: url('@/pages/goldenAutumn/assets/lsqsjnb_120_120.png') no-repeat left top/100% 100%;
          }
          &.status3{
            background: url('@/pages/goldenAutumn/assets/yyfqjnb_120_120.png') no-repeat left top/100% 100%;
          }
          &.noCoin{
            opacity: 0.6;
          }
  ...
  .marketBox{
    ...
    height: 1767px;
    border-image-source: none;
    background: url('@/pages/goldenAutumn/assets/mk4_22.png') no-repeat left top/100% 100%;
    padding-top: 96px;
    position: relative;
    .marketTip{
      font-weight: 500;
    ...
    .marketsItem{
      ...
      .boothIt{
        width: 208px;
        height: 282px;
        background: url('@/pages/goldenAutumn/assets/mk4_24.png') no-repeat left top/100% 100%;
        margin: 0 5px;
        position: relative;
        &.bigger{
          width: 263px;
          height: 282px;
          background: url('@/pages/goldenAutumn/assets/mk4_23.png') no-repeat left top/100% 100%;
        }
        .boothItAward{
          width: 128px;
          height: 128px;
          ...
          .boothItAward_preview{
            width: 120px;
            height: 26px;
            background: url('@/pages/goldenAutumn/assets/mk4_29.png') no-repeat left top/100% 100%;
            position: absolute;
            left: 50%;
            transform: translateX(-50%);
            bottom: 32px;
