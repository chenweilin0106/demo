...
.previewImg{
  ...
  &.gift{
    width: 427px;
    height: 740px;
    background: url('@/pages/goldenAutumn/assets/tk_39.png') no-repeat left top/100% 100%;
    border: none;
    border-radius: 0px;
  }
  &.titleSp{
  ...
  &.cpCardSp{
    ...
    .cpIcon{
      width: 394px;
      height: 180px;
      background: url('@/pages/goldenAutumn/assets/tk_50.png') no-repeat left top/100% 100%;
      position: absolute;
      left: 50%;
      top: 46%;
