...
.component {
  ...
  .wheelDiscArea {
    ...
    .rewardItem {
      ...
      position: absolute;
      &.rare1{
        background: url('@/pages/goldenAutumn/assets/mk5_15.png') no-repeat left top/100% 100%;
      }
      &.rare2{
        background: url('@/pages/goldenAutumn/assets/mk5_14.png') no-repeat left top/100% 100%;
      }
      &:nth-of-type(1) {
        left: 40px;
        top: 100px;
      ...
      .ldSpMarkDiv{
        width: 82px;
        height: 56px;
        background: url('@/pages/goldenAutumn/assets/mk5_30.png') no-repeat left top/100% 100%;
        position: absolute;
        right: -15px;
        bottom: 35px;
      }
  ...
  .lotteryArea {
    ...
    .lotteryBtnDiv{
      ...
      .lotteryOne{
        width: 242px;
        height: 128px;
        background: url('@/pages/goldenAutumn/assets/mk5_17.png') no-repeat left top/100% 100%;
      }
      .lotteryTen{
        width: 242px;
        height: 128px;
        background: url('@/pages/goldenAutumn/assets/mk5_18.png') no-repeat left top/100% 100%;
      }
      .lotteryFifty{
        width: 242px;
        height: 128px;
        background: url('@/pages/goldenAutumn/assets/mk5_19.png') no-repeat left top/100% 100%;
      }
    }
  }
}
