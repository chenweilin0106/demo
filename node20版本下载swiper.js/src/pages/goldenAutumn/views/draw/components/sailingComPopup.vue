...
.isTodayNoTipArea{
  ...
  .isTodayNoTipIcon{
    ...
    height: 46px;
    &.act{
      background: url('@/pages/goldenAutumn/assets/tk_16.png') no-repeat left top/100% 100%;
    }
    &.unact{
      background: url('@/pages/goldenAutumn/assets/tk_17.png') no-repeat left top/100% 100%;
    }
  }
}
</style>
