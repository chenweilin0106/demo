...
.layout {
  ...
  .tabs_box {
    margin-top: 524 - $bannerHeight; /*tab盒子距离banner的距离 蓝湖上是tab盒子距离页面顶部距离 - banner高度*/
    width: 750px;
    height: 82px * 2 + 10;
    ...
    .tab {
      ...
      @mixin tab($width: 226px, $height: 82px, $top: auto, $right: auto, $bottom: auto, $left: auto) {
        width: $width;
        height: $height;
        top: $top;
        right: $right;
  ...
  .BottomText {
    ...
    $topGap: 479 - $fontGap;
    $bottomGap: 82 - $fontGap;
    z-index: -1;
    width: 750px; /*底部图片宽度*/
    height: 140px; /*底部图片高度*/
    background: url('@/pages/goldenAutumn/assets/back_4.png') no-repeat left top/100% 100%; /*底部图片*/
    display: flex;
