  ...
  <div class="RechargeRebate">
    ...
    <out-box class="consume-list">
      <div class="consume-tabs">
        <div
          ...
          :class="[
            'tab',
            'flex-center',
            { 'tab-active': RechargeGiftListMark == item }
          ]"
      ...
      <div
        ...
        :class="[
          'tabs_contain',
          { 'special-class': RechargeGiftListMark == '连续充值有礼' }
        ]"
      >
        <!-- 累积充值有礼和连续充值有礼组件 -->
        <RechargeGiftList
  ...
  .consume-list {
    ...
    .consume-tabs {
      ...
      .tab {
        ...
        width: 346px;
        height: 74px;
        background: linear-gradient(0deg, #a71c24, #dd4429);
        font-size: 32px;
        color: #f1ca89;
      ...
      .tab-active {
        ...
        background: url('@/pages/lanternFestival/assets/tab_2.png') no-repeat
          left top/100% 100%;
        line-height: 0;
        padding-top: 40px;
      }
