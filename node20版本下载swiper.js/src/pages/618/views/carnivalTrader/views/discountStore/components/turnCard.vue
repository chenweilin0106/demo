  ...
  .card {
    ...
    .flipItem {
      ...
      .cardBack {
        width: 204px;
        height: 267px;
        background: url('@/pages/618/assets/mk5_10.png') no-repeat left top/100% 100%;
      }
      .cardFace {
        width: 204px;
        height: 267px;
        ...
        left: 0;
        top: 0;
        background: url('@/pages/618/assets/mk5_11.png') no-repeat left top/100% 100%;
        ...
        &.rare {
          background: url('@/pages/618/assets/mk5_12.png') no-repeat left top/100% 100%;
        }
        .awardIcon {
          width: 120px;
          height: 120px;
        ...
        .buyBtn {
          ...
          bottom: 10px;
          &.buyed{
            background: url('@/pages/618/assets/mk5_35.png') no-repeat left top/100% 100%;
          }
          &.canBuy{
            background: url('@/pages/618/assets/mk5_34.png') no-repeat left top/100% 100%;
          }
          .coinIcon{
            width: 46px*0.8;
            height: 46px*0.8;
    ...
    .cardTurned {
      ...
      .rareIcon {
        width: 112px;
        height: 131px;
        background: url('@/pages/618/assets/mk5_17.png') no-repeat left top/100% 100%;
        position: absolute;
        left: -30px;
        top: -50px;
      }
