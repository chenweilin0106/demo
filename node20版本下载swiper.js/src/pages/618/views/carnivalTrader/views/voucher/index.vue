<template>
  <div class="voucherCompo">
    <div class="viewExDiv">
      <div class="viewExBtn" @click="viewExBtnCk(1)"></div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      day_list: [
        { id: 1, type: 'masonry', price: 30, need_price: 30, text: '满30钻可用', end_time: '06.18 12:59', receive_end_time: '13:00', start_time: '0:00', has_right: 1 }, // 0 已过期 1 可领取 2 已领取 3 未可领
        { id: 2, type: 'masonry', price: 90, need_price: 500, text: '满500钻可用', end_time: '06.18 23:59', receive_end_time: '23:59', start_time: '13:00', has_right: 1 }
      ], // 每日领取代金券列表
        ...
        getPageData({ type: 'carnival_trader_voucher_sign' }).then((res) => {
          if (res.errno == 0) {
            ...
            if (res.data.length > 0) {
              this.configReceiveVoucherPopup = res.data
...
.voucherCompo{
  width: 738px;
  height: 2250px;
  background: url('@/pages/618/assets/mk5_3_1.png') no-repeat left top/100% 100%;
  ...
  .viewExDiv{
    width: 509px;
    height: 79px;
    background: url('@/pages/618/assets/mk5_2.png') no-repeat left top/100% 100%;
    margin: 0 auto 0px auto;
    .viewExBtn{
      width: 250px;
      height: 79px;
  ...
  .signInArea{
    ...
    .signItem{
      width: 177px;
      height: 253px;
      background: url('@/pages/618/assets/mk5_18.png') no-repeat left top/100% 100%;
      margin: 0 20px;
      position: relative;
      z-index: 2;
      .signItemPirice{
      ...
      .signItemReceive{
        width: 175px;
        height: 250px;
        background: url('@/pages/618/assets/mk5_18_1.png') no-repeat left top/100% 100%;
        position: absolute;
        left: 1px;
        top: 1px;
      }
      .signItemStatus{
        ...
        bottom: -80px;
        &.status1{
          background: url('@/pages/618/assets/mk5_22.png') no-repeat left top/100% 100%;
        }
        &.status2{
          background: url('@/pages/618/assets/mk5_21.png') no-repeat left top/100% 100%;
        }
        .signItemNum{
          font-weight: 500;
          font-size: 24px;
  ...
  .signBtn{
    ...
    position: relative;
    &.status1{
      background: url('@/pages/618/assets/mk5_25.png') no-repeat left top/100% 100%;
    }
    &.status2{
      background: url('@/pages/618/assets/mk5_23.png') no-repeat left top/100% 100%;
    }
    &.status3{
      background: url('@/pages/618/assets/mk5_24.png') no-repeat left top/100% 100%;
    }
    .signHavenText{
      font-weight: bold;
      font-size: 22px;
  ...
  .dailyArea{
    ...
    .dailyItem{
      width: 475px;
      height: 168px;
      background: url('@/pages/618/assets/mk5_19.png') no-repeat left top/100% 100%;
  ...
  .myVoucherArea{
    ...
    .myVoucherItem{
      width: 617px;
      height: 149px;
      background: url('@/pages/618/assets/mk5_20.png') no-repeat left top/100% 100%;
      ...
      .myVoucherItemLock{
        width: 617px;
        height: 149px;
        background: url('@/pages/618/assets/mk5_20_1.png') no-repeat left top/100% 100%;
        position: absolute;
        left: 0;
        top: 0;
      }
      .myVoucherItemChapter{
        ...
        transform: translateY(-50%);
        &.status2{
          background: url('@/pages/618/assets/mk5_33.png') no-repeat left top/100% 100%;
        }
        &.status3{
          background: url('@/pages/618/assets/mk5_32.png') no-repeat left top/100% 100%;
        }
      }
    }
    .noMyVoucher{
