<template>
  <div class="PointReward">
    <ThemeBox class="PointReward_TaskListContent" themeTitleImg="mk1_1.png">
      <TaskListItem
    ...
    <ThemeDialog
      ...
      :titleIconObj="{ exchargeGift: 'title_9.png' }"
...
export default {
  ...
  methods: {
    ...
    async onExcharge(num) {
      ...
      console.log(this.dialogData.max_times)
