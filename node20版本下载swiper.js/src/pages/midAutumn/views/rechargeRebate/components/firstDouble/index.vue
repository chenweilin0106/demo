...
.FirstDouble {
  ...
  .ruleIcon {
    top: 94px; /*todo 规则图标距离顶部距离*/
    right: 29px; /*todo 规则图标距离右侧距离*/
  ...
  ::v-deep .RechargeRebate_TopBox_Button {
    ...
    &.button-receive {
      .main {
        color: #fff; /*todo 未完成状态按钮字体颜色*/
        background: linear-gradient(0deg, #369EA7, #8CE7BB); /*todo 未完成状态按钮背景色*/
      }
    }
  }
  .RechargeRebate_TopBox_Article {
    ...
    width: 660px;
    height: 320px;
    background: linear-gradient(180deg, #FFB85D, #EF8133); /*todo 首充充值文本背景 图片或者手写渐变*/
    border-radius: 30px;
    .articleTitle {
      position: relative;
      margin: 0 auto 20px;
