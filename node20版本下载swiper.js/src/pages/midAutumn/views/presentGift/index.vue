...
<script>
import GiftUpdate from '@/pages/midAutumn/views/presentGift/components/giftUpdate.vue' // 礼物焕新
import RobRewards from '@/pages/midAutumn/views/presentGift/components/robRewards.vue' // 打劫有礼
// import LimitDiscount from '@/pages/midAutumn/views/presentGift/components/limitDiscount.vue' // 限时折扣
// import CpRewards from '@/pages/midAutumn/views/presentGift/components/cpRewards.vue' // cp贺礼
import CumulativeSpendingList from '@/pages/midAutumn/views/presentGift/components/cumulativeSpendingList' // 累计消费
