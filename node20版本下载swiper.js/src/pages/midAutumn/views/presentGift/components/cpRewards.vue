...
.cpRewards {
  ...
  .button {
    ...
    &.button-noFinish {
      ...
      background: url('@/pages/midAutumn/assets/mk2_19.png') no-repeat left top/100% 100%; /*todo 未完成状态按钮背景色*/
    }
    &.button-receive {
      color: #fff; /*todo 未完成状态按钮字体颜色*/
      background: url('@/pages/midAutumn/assets/mk2_20.png') no-repeat left top/100% 100%; /*todo 未完成状态按钮背景色*/
    }
    &.button-finish {
      color: #fff; /*todo 未完成状态按钮字体颜色*/
      background: url('@/pages/midAutumn/assets/mk2_21.png') no-repeat left top/100% 100%; /*todo 未完成状态按钮背景色*/
    }
  }
}
</style>
