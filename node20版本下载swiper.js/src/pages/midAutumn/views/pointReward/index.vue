...
import TasksList from '@/pages/midAutumn/views/pointReward/components/tasksList.vue'
import ExchangeList from '@/pages/midAutumn/views/pointReward/components/exchangeList.vue'
import Jump2024 from '@/pages/midAutumn/views/pointReward/components/jump2024.vue'
const ExchangeGiftsPopup = () => import('@/pages/midAutumn/views/pointReward/popups/exchangeGiftsPopup.vue')
export default {
  name: 'pointReward',
  ...
  data() {
    return {
      ...
      goods_list: [
        ...
        { type: 'title', goods_name: '永久称号', goods_type: 'title', goods_id: 4987, goods_num: 0, price: 600, max_times: 1, goods_icon: 'ch_hzyx', goods_icon_t: 'ch_hzyx', goods_num_text: '永久称号+1', is_owned: false, is_lock: false, exchange_times: 0, has_right: 1 },
        ...
        { type: 'car_cfplh', goods_name: '玲珑玉兔', goods_type: 'car', goods_id: 58, goods_num: 7, price: 300, price_text: '300', max_times: 1, goods_icon: 'llyt_120_120.png', goods_icon_t: 'llyt_120_120.png', goods_num_text: '座驾+7天', is_owned: false, is_lock: false, exchange_times: 0, has_right: 1 },
      ...
      pointIcon: Object.freeze('yg_72_61.png'), // 道具图标
      pointName: Object.freeze('月桂') // 道具名称
    }
  },
  computed: {
    taskListData() {
