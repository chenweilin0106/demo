<template>
  <out-box class="CumulativeSpendingList position-relative" title="title_3.png" :candle="true" :petals-array="['petal-3', 'petal-4']">
    <!-- 领取项 -->
    <div class="PresentGift_TopBox_AwardList">
      <div class="PresentGift_TopBox_AwardItem" v-for="(item, key) in consume_status" :key="key">
        <div class="award-item-content">
          ...
          <div @click="ClickCumulativeBtn(item.has_right, key)" class="item-button-toDid button-noFinish" :class="ButtonStyle('1', item.has_right)">
