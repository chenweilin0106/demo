...
.RechargeRebate {
  position: relative;
  .consume-list {
    border-image-width: 0 0 192px 0;
    ...
    .consume-tabs {
      ...
      width: 738px;
      height: 105px;
      background: url('@/pages/foolDay/assets/zs_1.png') no-repeat left top/100% 100%;
      .tab {
        position: relative;
        flex: 1;
        height: 100%;
    ...
    // 底部tab栏活动
    .active-tab-bg {
      background: url('@/pages/foolDay/assets/zs_2.png') no-repeat left top/100% 100%;
    }
    .special-class {
