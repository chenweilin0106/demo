<template>
  <div class="DialogCounter">
    ...
    <!-- 特殊结算 -->
    <div class="special_billing" v-if="showSpecialBilling">
    ...
    <div class="billing" v-if="showBilling">
      ...
      <!-- 兑换按钮 -->
      <div class="theme_botton_did button" @click="clickSettlement">
        {{ buttonText }}
      </div>
    </div>
  </div>
...
.DialogCounter {
  ...
  .billing {
    ...
    > .button {
      ...
      font-size: 28px;
      color: #1069ff;
      background: url('@/pages/skillGift/assets/mk1_2.png') no-repeat left
        top/100% 100%;
    }
  }
}
