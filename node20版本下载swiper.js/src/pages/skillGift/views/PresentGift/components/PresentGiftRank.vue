<template>
  <div class="PresentGiftRank">
    ...
    <div class="rank_header">
      <div class="flex-center">排名</div>
      <div class="flex-center">名字</div>
      <div class="flex-center">价值(钻)</div>
      <div class="flex-center">奖励</div>
    </div>
    <!-- 排行榜列表 -->
    ...
    <div class="rule-text">
      <ul>
        <li>
          <span></span>活动期间，每日<i>赠送和获赠钻石礼物价值</i>最高的前
        </li>
...
.PresentGiftRank {
  ...
  .rank_header {
    ...
    display: flex;
    margin: 0 auto 6px;
    background: url('@/pages/skillGift/assets/mk3_1.png') no-repeat left
      top/100% 100%;
    > div {
      height: 100%;
      font-size: 24px;
  ...
  .rank_list {
    ...
    background: url('@/pages/skillGift/assets/mk3_2.png') no-repeat left
      top/100% 100%;
    .inner {
      width: 100%;
      height: 100%;
