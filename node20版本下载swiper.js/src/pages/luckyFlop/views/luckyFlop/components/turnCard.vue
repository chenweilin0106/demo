<template>
  <div class="turnCard">
    <div class="main">
      <div class="card" v-for="item in cardsTurnList" :key="item.id">
        ...
        <div :class="['flipItem', item.isFilp ? 'flip' : null]" v-if="item.is_flip === false" @click="turnCardCk(item, 1)" @animationend="FlipEnd(item)">
          ...
          <div :class="[
              'cardFace',
              item.flipEnd ? 'flipEnd' : null,
              item.award.is_rare ? 'rare' : 'null'
            ]" v-if="item.isFilp">
    ...
    <PopupBox v-if="isShowreRresh" @clickClose="clickClosereRresh">
      <div class="tips">当前卡牌已翻完，是否刷新</div>
      <div class="reshbtnDiv">
...
.turnCard {
  .main {
    ...
    .card {
      ...
      .flipItem {
        ...
        .cardBack {
          width: 218px;
          height: 278px;
          background: url('@/pages/luckyFlop/assets/mk4_5.png') no-repeat left top/100% 100%;
          .turnText {
            width: 135px;
            height: 45px;
            background: url('@/pages/luckyFlop/assets/mk4_7.png') no-repeat left top/100% 100%;
            position: absolute;
            left: 50%;
          ...
          .free {
            width: 140px;
            height: 38px;
            background: url('@/pages/luckyFlop/assets/mk4_6.png') no-repeat left top/100% 100%;
            position: absolute;
            left: 40%;
            transform: translate(-50%);
            bottom: 70px;
          ...
          .needCoinNum {
            width: 152px;
            height: 30px;
            background: url('@/pages/luckyFlop/assets/mk4_10.png') no-repeat left top/100% 100%;
            position: absolute;
            left: 50%;
            transform: translate(-50%);
            bottom: 70px;
          ...
          .isLock {
            width: 218px;
            height: 278px;
            background: url('@/pages/luckyFlop/assets/mk4_9.png') no-repeat left top/100% 100%;
            z-index: 3;
            position: absolute;
            left: 0;
            top: 0;
        ...
        .cardFace {
          ...
          left: 0;
          top: 0;
          background: url('@/pages/luckyFlop/assets/mk4_5_1.png') no-repeat left top/100% 100%;
          ...
          .rareIcon {
            width: 80px;
            height: 38px;
            background: url('@/pages/luckyFlop/assets/icon_xy.png') no-repeat left top/100% 100%;
            position: absolute;
            top: -10px;
            left: 140px;
          }
          ...
          &.rare {
            background: url('@/pages/luckyFlop/assets/mk4_5_2.png') no-repeat left top/100% 100%;
            .givedIcon {
              background: url('@/pages/luckyFlop/assets/mk4_10.png') no-repeat left top/100% 100%;
            }
          }
    ...
    .tip1 {
      ...
      width: 407px;
      height: 63px;
      background: url('@/pages/luckyFlop/assets/mk4_8.png') no-repeat left top/100% 100%;
      top: 290px;
      left: 50%;
      transform: translate(-50%);
    }
    .tip2 {
      ...
      width: 407px;
      height: 63px;
      background: url('@/pages/luckyFlop/assets/mk4_23.png') no-repeat left top/100% 100%;
      top: 650px;
      left: 50%;
      transform: translate(-50%);
    }
  ...
  .btnDiv {
    ...
    .refreshBtn {
      width: 80px;
      height: 80px;
      background: url('@/pages/luckyFlop/assets/mk4_11.png') no-repeat left top/100% 100%;
    }
    .turnOneBtnFree {
      width: 242px;
      height: 144px;
      background: url('@/pages/luckyFlop/assets/btn_7.png') no-repeat left top/100% 100%;
      margin-top: -30px;
    }
    .turnOneBtn {
      width: 242px;
      height: 144px;
      background: url('@/pages/luckyFlop/assets/btn_7_2.png') no-repeat left top/100% 100%;
      margin-top: -30px;
      .num {
        color: #6359e4;
        position: relative;
    ...
    .turnAllBtn {
      width: 242px;
      height: 144px;
      background: url('@/pages/luckyFlop/assets/btn_8_1.png') no-repeat left top/100% 100%;
      margin-top: -30px;
      .num {
        color: #ffffff;
        position: relative;
    ...
    .recordsBtn {
      width: 80px;
      height: 80px;
      background: url('@/pages/luckyFlop/assets/mk4_12.png') no-repeat left top/100% 100%;
    }
  }
