<template>
  <div :id="svgaName" class="PublicSvga flex-center">
    <!-- 用户头像 -->
...
export default {
  ...
  computed: {
    svgaId() {
      return `${this.svgaName}_${Date.now()}_${Math.floor(
        Math.random() * 10000
      )}`
    }
  },
  ...
  methods: {
    ...
    loadSvga() {
      this.$nextTick(() => {
        ...
        this.svga_data = svgaFn(this.svgaName, this.svgaId, this.loops)
