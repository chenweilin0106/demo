<template>
  ...
  >
    ...
    <div
      ...
      :class="ButtonStyle('1', single_recharge_status.has_right)"
    >
  ...
  data() {
    return {
      awardObj: Object.freeze({
        ...
        car: { icon: 'asqbt_120_120.png', text: '座驾+1天' }
      })
    }
  },
  methods: {
...
.Single_RechargeGift {
  ...
  .RechargeRebate_TopBox_Button {
    ...
    font-size: 32px;
    //color: #fff;
    //background: linear-gradient(0deg, #8fa7ff, #acddff);
    //border: 2px solid #ffffff;
  }

  .button-receive {
    background: linear-gradient(0deg, #b884ff, #faa9ff);
    border: 2px solid #ffffff;
    color: #ffffff;
  }
  ...
  .RechargeRebate_TopBox_Article {
    ...
    width: 660px;
    height: 320px;
    background: linear-gradient(180deg, #907aff, #f0aaff);
    border-radius: 30px;
