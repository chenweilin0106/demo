<template>
  <div class="PointReward">
    <out-box class="PointReward_TaskListContent" :left-icon="true">
      <div class="task_list">
        <TaskListItem
    ...
    <out-box
      class="PointReward_BottomBox"
      title="title_1.png"
      :right-icon="true"
      :left-icon="true"
    >
      <!-- 我的道具 -->
      <div class="theme_present PointReward_BottomBox_Present flex-center">
        我的{{ pointName }}<img :src="IconPath(pointIcon)" />：<span
          class="PointReward_BottomBox_present_nums flex-center"
          >{{ pageData.my_goods }}
        </span>
      </div>
      <!-- 兑换好礼列表 -->
...
// 数据请求
import { moduleOne } from '../../../../api/index'
