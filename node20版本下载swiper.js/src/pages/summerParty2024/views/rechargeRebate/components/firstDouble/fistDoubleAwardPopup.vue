...
.smallContent {
  width: 522px;
  height: 523px;
  background-image: url('@/pages/summerParty2024/assets/tk_9.png');
  .title {
    margin-top: -43px;
    background-image: url('@/pages/summerParty2024/assets/tk_4.png');
  }
  .text {
    width: 556px;
    background-image: url('@/pages/summerParty2024/assets/tk_6.png');
  }
  .awardText {
    color: #ffffff;
  }
...
.bigContent {
  ...
  width: 646px;
  height: 644px;
  background-image: url('@/pages/summerParty2024/assets/tk_10.png');
  .title {
    margin-top: 26px;
    background-image: url('@/pages/summerParty2024/assets/tk_5.png');
  }
  .text {
    width: 569px;
    background-image: url('@/pages/summerParty2024/assets/tk_7.png');
  }
  .awardText {
    color: #e02424;
  }
