...
<script>
import { toRuneStoneTreasureHuntPanel } from '@/pages/summerParty2024/utils/toApp'
...
.backpack-icon {
  ...
  width: 139px;
  height: 140px;
  background: url('@/pages/summerParty2024/assets/tk_50.png') no-repeat left top/100% 100%;
}
