...
@mixin textMixin() { /*todo 奖励名称， 我的道具文本背景色*/
  background-color: #466BD5; // 背景色
  color: #fff; // 字体颜色
}
$cardBorderRadius: 20px; /*todo 卡片圆角,卡片奖励左上和左下圆角,锁定阴影左上角圆角*/
.exchangeList {
  margin-top: 132px; /*todo 兑换列表上方margin*/
  padding-top: 76px; /*todo 兑换列表上方padding*/
  // 顶部道具数量
  .my-goods {
    display: flex;
    align-items: center;
    ...
    @include textMixin;
    > img {
      width: 47px; /*todo 我的道具图标宽度*/
      height: 37px; /*todo 我的道具图标高度*/
    }
  }
  .exchange-item {
    position: relative;
    ...
    .left-content {
      height: 100%;
      width: 240px;
      //background: url('@/pages/summerParty2024/assets/') no-repeat left top/100% 100%; // 背景
      .icon-content {
        height: 124px;
        background: linear-gradient(180deg, #FFFACD, #FFFFFF); /*todo 兑换列表中道具图标背景色*/
