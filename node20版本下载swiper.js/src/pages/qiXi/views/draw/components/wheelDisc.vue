...
.component {
  ...
  .wheelDiscArea {
    ...
    .rewardItem {
      ...
      position: absolute;
      &.rare1{
        background: url('@/pages/qiXi/assets/mk5_8.png') no-repeat left top/100% 100%;
      }
      &.rare2{
        background: url('@/pages/qiXi/assets/mk5_7.png') no-repeat left top/100% 100%;
      }
      &:nth-of-type(1) {
        right: 190px;
        top: 10px;
  ...
  .lotteryArea {
    ...
    .lotteryBtnDiv{
      ...
      .lotteryOne{
        width: 242px;
        height: 128px;
        background: url('@/pages/qiXi/assets/mk5_11.png') no-repeat left top/100% 100%;
      }
      .lotteryTen{
        width: 242px;
        height: 128px;
        background: url('@/pages/qiXi/assets/mk5_12.png') no-repeat left top/100% 100%;
        &.tenSp{
          background: url('@/pages/qiXi/assets/mk5_12_1.png') no-repeat left top/100% 100%;
        }
      }
      .lotteryFifty{
        width: 242px;
        height: 128px;
        background: url('@/pages/qiXi/assets/mk5_13.png') no-repeat left top/100% 100%;
      }
    }
  }
}
