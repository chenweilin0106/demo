<template>
  <OutBox class="CumulativeSpendingList position-relative" title="title_7.png" :bottomGap="false">
...
.CumulativeSpendingList {
  .resetIcon {
    z-index: 1;
    top: -22px; /*todo 每日重置图标top 根据容器定位*/
  ...
  .listMain {
    ...
    .taskItem {
      ...
      position: relative;
      margin-bottom: 22px;
      width: 656px; /*todo 卡片宽度 不需要加上外圈描边宽度*/
      ...
      .awardItem {
        ...
        .awardText {
          ...
          color: #fff;
          width: 100%;
          background-color: #4F72D5; /*todo 奖励文本背景色*/
