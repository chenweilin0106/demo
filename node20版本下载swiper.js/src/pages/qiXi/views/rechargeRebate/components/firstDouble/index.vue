<template>
  <OutBox class="FirstDouble" title="title_2.png" has-costume>
    ...
    <PublicButton
      class="RechargeRebate_TopBox_Button margin-row-center"
      :hasRight="single_recharge_status.has_right"
...
.FirstDouble {
  //margin-top: -20px; /*todo 顶部margin 距离tab高度*/
  //padding-top: 80px; /*todo 顶部padding 距离第一行文本的高度*/
  .RechargeRebate_TopBox_Title {
    color: #575FCB; /*todo 一行文本字体颜色*/
    p:nth-child(1) {
      font-weight: bold;
      font-size: 30px;
      margin-bottom: 17px;
  ...
  .ruleIcon {
    top: 85px; /*todo 规则图标距离顶部距离*/
    right: 30px; /*todo 规则图标距离右侧距离*/
  ...
  .RechargeRebate_TopBox_Body {
    .RechargeRebate_TopBox_Body_Item {
      ...
      height: 168px;
      padding: 4px;
      background-color: #99C1FD; /*todo 奖励边框颜色*/
      border-radius: 16px;
      .img-box {
        height: 112px;
        background: linear-gradient(180deg, #FFF3BE, #FFFFFF); /*todo 奖励图标背景色*/
      ...
      .img-bottom {
        background: #4F72D5; /*todo 奖励文字背景色*/
  ...
  .RechargeRebate_TopBox_Button {
    margin-top: 16px; /*todo 按钮距离奖励列表的间距*/
    margin-bottom: 21px; /*todo 按钮距离首充充值文本的间距*/
    width: 316px;
    height: 109px;
    font-size: 32px;
    box-shadow: none;
    &.button-noFinish {
      ...
      background: url('@/pages/qiXi/assets/mk2_19.png') no-repeat left top/100% 100%; /*todo 未完成状态按钮背景色*/
    }
    &.button-receive {
      color: #fff; /*todo 未完成状态按钮字体颜色*/
      background: url('@/pages/qiXi/assets/mk2_20.png') no-repeat left top/100% 100%; /*todo 未完成状态按钮背景色*/
    }
    &.button-finish {
      color: #fff; /*todo 未完成状态按钮字体颜色*/
      background: url('@/pages/qiXi/assets/mk2_21.png') no-repeat left top/100% 100%; /*todo 未完成状态按钮背景色*/
    }
  }
  .RechargeRebate_TopBox_Article {
    ...
    width: 660px;
    height: 320px;
    background: linear-gradient(0deg, #EEBDF5, #7C9EFF); /*todo 首充充值文本背景 图片或者手写渐变*/
    border-radius: 30px;
    .articleTitle {
      position: relative;
      margin: 0 auto 20px;
