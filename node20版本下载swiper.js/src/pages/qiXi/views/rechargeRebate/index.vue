<template>
  <div class="RechargeRebate">
    ...
    <div
      class="RechargeRebate_BottomBox margin-row-center"
      :class="{
...
.RechargeRebate {
  ...
  .RechargeRebate_BottomBox {
    ...
    margin-top: 55px; /*todo 距离礼盒距离*/
    border-image-slice: 108 0 290 0 fill; /*todo 顶部距离是一般tab高度 底部距离一般和outBox一致*/
    border-image-width: 108px 0 290px 0; /*todo 顶部距离是一般tab高度 底部距离一般和outBox一致*/
    border-image-source: url('@/pages/qiXi/assets/zs_3.png'); /*todo 连续充值有礼背景*/
    ...
    .RechargeRebate_BottomBox_Tab {
      ...
      .resetIcon {
        top: -1px; /*todo 重置图标 距离tab top*/
        left: 14px; /*todo 重置图标 距离tab left*/
        width: 124px;
        height: 42px;
        background: url('@/pages/qiXi/assets/mk2_1.png') no-repeat left top/100% 100%; /*todo 图片名 可能要改*/
      }
      .update-1 {
        position: absolute;
        top: -18px; /*todo 重置图标 距离tab bottom*/
        left: 287px; /*todo 重置图标 距离tab left*/
        width: 96px;
        height: 128px;
        background: url('@/pages/qiXi/assets/mk2_5.png') no-repeat left top/100% 100%; /*todo 图片名 可能要改*/
      }
      .tab {
        position: relative;
        flex: 1;
  ...
  .active-tab-bg {
    border-image-source: url('@/pages/qiXi/assets/zs_4.png'); /*todo 连续充值有礼边框背景图片名*/
  }
}
</style>
