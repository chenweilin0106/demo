...
export default {
  ...
  computed: {
    ...
    // 绿晶石 紫晶石 科举卡 兑换按钮
    isNormalExchange() {
      return ['tools', 'keju', 'pretty_card'].some((item) => this.dialogData.type?.startsWith(item))
    },
    // 称号 头饰 座驾 声波 聊天气泡 主页特效 兑换按钮
    isSeniorExchange() {
...
.goodsIcon {
  margin: 0 5px;
  width: 46px; /*todo 剩余道具图标宽度*/
  height: 45px; /*todo 剩余道具图标高度*/
}
// 剩余道具
.remainingPoint {
  font-size: 32px;
...
.promptIcon {
  ...
  border: $borderWidth solid #A7DFFF; /*todo 边框颜色*/
