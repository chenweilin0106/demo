...
import TasksList from '@/pages/qiXi/views/pointReward/components/tasksList.vue'
import ExchangeList from '@/pages/qiXi/views/pointReward/components/exchangeList.vue'
const ExchangeGiftsPopup = () => import('@/pages/qiXi/views/pointReward/popups/exchangeGiftsPopup.vue')
export default {
  name: 'pointReward',
  ...
  data() {
    return {
      ...
      goods_list: [
        ...
        { type: 'title', goods_name: '永久称号', goods_type: 'title', goods_id: 4987, goods_num: 0, price: 600, max_times: 1, goods_icon: 'ch_ymlw', goods_icon_t: 'ch_ymlw', goods_num_text: '永久称号+1', is_owned: false, is_lock: false, exchange_times: 0, has_right: 1 },
      ...
      pointIcon: Object.freeze('yh_67_68.png'), // 道具图标
      pointName: Object.freeze('烟花') // 道具名称
    }
  },
  computed: {
    taskListData() {
