<template>
  <OutBox class="tasksList" has-costume>
...
.tasksList {
  margin-top: -113px; /*todo 任务列表上方外间距 */
  //padding-top: 88px; /*todo 任务列表上方内间距*/
  .task-item {
    position: relative;
    display: flex;
    align-items: center;
    margin: 0 auto 6px; /*todo 下间距*/
    width: 674px; /*todo 卡片宽度 不需要加上外圈描边宽度*/
    height: 154px; /*todo 卡片高度 不需要加上外圈描边宽度*/
    ...
    .icon-content {
      ...
      border-radius: 16px;
      background-color: #A7DFFF; /*todo 任务列表中道具边框颜色*/
      .icon {
        width: 100%;
        height: 68px;
      ...
      .text {
        ...
        white-space: nowrap;
        line-height: 100%;
        background-color: #466BD5; /*todo 背景色*/
        color: #fff; /*todo 字体颜色*/
      }
    }
    .text-content {
  ...
  .rules-text {
    img {
      width: 46px; /*todo 道具宽度*/
      height: 45px; /*todo 道具高度*/
    }
  }
}
</style>
