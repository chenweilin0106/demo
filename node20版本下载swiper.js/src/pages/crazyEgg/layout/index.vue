<template>
  <div class="layout">
    ...
    <!--tab盒子-->
    <div class="tabs_box">
      <div v-for="(tab, index) in tabsArray" class="theme_tab_item flex_across" :key="index" @click="track(tab.tabName, tab.to)">
...
export default {
  ...
  data() {
    return {
      ...
      tabsArray: Object.freeze([
        { tabName: '积分兑奖', to: '/pointReward', icon: 'tab_1.png', activeIcon: 'tab_1_1.png' },
        { tabName: '充值有礼', to: '/rechargeRebate', icon: 'tab_2.png', activeIcon: 'tab_2_2.png' },
        { tabName: '钻石送礼', to: '/presentGift', icon: 'tab_3.png', activeIcon: 'tab_3_3.png' },
        { tabName: '疯狂砸蛋', to: '/crazyEgg', icon: 'tab_4.png', activeIcon: 'tab_4_4.png' }
      ])
    }
  },
  computed: {
  ...
  methods: {
    ...
    track(module, path) {
      ...
      this.$thinking.track('WebClick', { element: module, module }) // 数数点击埋点
