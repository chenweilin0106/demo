...
export default {
  ...
  data() {
    return {
      ...
      tot_pick_list: [
        { id: 30, need_num: 30, award: { id: 11, type: 'chat_bubble', nums: 3, name: '气泡', text: '+3天', icon: 'qb_xdsk' }, has_right: 2 },
        { id: 66, need_num: 66, award: { id: 158, type: 'tool', nums: 2, name: '藏宝图', text: '+2', icon: 'cbt_120_120.png' }, has_right: 2 },
        { id: 88, need_num: 88, award: { id: 0, type: 'luck_key', nums: 1, name: '钥匙', text: '+1', icon: 'xyys_120_120.png' }, has_right: 2 },
        { id: 188, need_num: 188, award: { id: 75, type: 'pst_privilege', nums: 7, name: '礼物赠送权', text: '+7天', icon: 'jtlppq_120_120.png', mark: '520' }, has_right: 2 },
        { id: 288, need_num: 288, award: { id: 159, type: 'tool', nums: 2, name: '黄金藏宝图', text: '+2', icon: 'hjcbt_120_120.png' }, has_right: 1 },
        { id: 388, need_num: 388, award: { id: 64, type: 'car', nums: 15, name: '座驾', text: '+15天', icon: 'lgxyc_120_120.png' }, has_right: 1 }
      ], // 进度条列表
