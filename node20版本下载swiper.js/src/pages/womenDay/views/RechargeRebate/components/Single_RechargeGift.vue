<template>
  ...
  >
    ...
    <!-- 充值奖励道具列表 -->
    <div
      class="RechargeRebate_TopBox_Body flex justify-center align-center flex-no-wrap"
    >
      <div
        :class="[
    ...
    <div class="RechargeRebate_TopBox_Article">
      ...
      <div
        class="article-button flex justify-center align-center"
...
.Single_RechargeGift {
    ...
    .RechargeRebate_TopBox_Body_Item {
      ...
      .inner {
        ...
        .icon-box {
          width: 100%;
          height: 112px;
          background: linear-gradient(180deg, #f6d182, #ffffff);
  ...
  .RechargeRebate_TopBox_Article {
    ...
    width: 660px;
    height: 320px;
    background: linear-gradient(180deg, #cba24a, #ab784e);
    border-radius: 30px;
  ...
  .button-noFinish {
    color: #fff;
    border: 3px solid #ffffff;
    background: linear-gradient(0deg, #7a94f8, #acddff);
  }
