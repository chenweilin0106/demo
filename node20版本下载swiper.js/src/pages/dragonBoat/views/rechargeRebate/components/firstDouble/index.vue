<template>
  <OutBox class="FirstDouble" title="title_2.png" :bottom="true">
    ...
    <div class="RechargeRebate_TopBox_Article margin-row-center position-relative">
      ...
      <p class="text-nowrap">2.活动期间<span class="focus-color">648及以下</span>额度首充双倍福利每日重置</p>
...
.FirstDouble {
  ...
  .RechargeRebate_TopBox_Body {
    ...
    .RechargeRebate_TopBox_Body_Item {
      ...
      .img-box {
        ...
        //  width: 32px;
        //  height: 32px;
        //  background: url('@/pages/dragonBoat/assets/mk6_6.png') no-repeat left top/100% 100%;
        //  .bubbleMain {
        //    top: -61px;
        //    right: -53px;
        //    width: 286px;
        //    height: 59px;
        //    background: url('@/pages/dragonBoat/assets/mk2_13.png') no-repeat left top/100% 100%;
        //  }
        //}
        > img {
          height: 100%;
      ...
      &:nth-child(3) {
        ...
        .img-box {
          background-image: linear-gradient(180deg, #fcf2c3, #ffffff);
        }
        .img-bottom {
  ...
  .RechargeRebate_TopBox_Button {
    ...
    &.button-receive {
      background-image: linear-gradient(0deg, #ff853b, #f9d853);
      color: #fff;
    }
  }
