...
import { Toast, Popup, Swipe, SwipeItem, NoticeBar, Popover, CountDown, Field } from 'vant'
...
import OutBox from './components/outBox2.vue'
import PopupBox from './components/popupBox2.vue'
...
Vue.use(Toast).use(Popup).use(Swipe).use(SwipeItem).use(NoticeBar).use(Popover).use(CountDown).use(Field)
