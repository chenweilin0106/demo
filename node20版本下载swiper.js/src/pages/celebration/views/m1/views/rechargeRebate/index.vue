<template>
  <div class="RechargeRebate">
    ...
    <RechargeFree @update="getPageData" />
    <GiftUpdate @update="updateGiftUpdate" @recharge="onRecharge" />
    <OutBox
      ...
      <div class="RechargeRebate_BottomBox_Tab">
        ...
        <div v-if="recharge_status[30].awards[0].text_add" class="update-1"></div>
...
import RechargeFree from '@/pages/celebration/views/m1/views/rechargeRebate/components/rechargeFree/index.vue'
import GiftUpdate from '@/pages/celebration/views/m1/views/rechargeRebate/components/giftUpdate/index.vue'
import RechargeTasksList from '@/pages/celebration/views/m1/views/rechargeRebate/components/rechargeTasksList.vue'
import FirstDouble from '@/pages/celebration/views/m1/views/rechargeRebate/components/firstDouble/index.vue'
...
export default {
  ...
  components: { FirstDouble, RechargeTasksList, GiftUpdate, RechargeFree },
  ...
  data() {
    return {
      ...
      accruing_days_list: {
        10: {
          ...
          awards: [
            ...
            { icon: 'zjs_60_60.png', id: 142, name: '紫晶石', nums: 13, text: '13', type: 'tool' },
        ...
        30: {
          ...
          awards: [
            ...
            { icon: 'zjs_60_60.png', id: 142, name: '紫晶石', nums: 30, text: '30', type: 'tool' },
            { icon: 'lhq_60_60.png', id: 0, name: '靓号券', nums: 1, text: '1', type: 'pretty_card' }
          ],
          // days_cond: '4',
          days_cond: '5',
        ...
        50: {
          ...
          awards: [
            ...
            { icon: 'zjs_60_60.png', id: 142, name: '紫晶石', nums: 38, text: '38', type: 'tool' },
            { icon: 'lhq_60_60.png', id: 0, name: '靓号券', nums: 1, text: '1', type: 'pretty_card' }
          ],
          // days_cond: '4',
          days_cond: '5',
        ...
        300: {
          ...
          awards: [
            ...
            { icon: 'zjs_60_60.png', id: 142, name: '紫晶石', nums: 85, text: '85', type: 'tool' },
            { icon: 'lhq_60_60.png', id: 0, name: '靓号券', nums: 1, text: '1', type: 'pretty_card' }
          ],
          // days_cond: '4',
          days_cond: '5',
        ...
        500: {
          ...
          awards: [
            ...
            { icon: 'zjs_60_60.png', id: 142, name: '紫晶石', nums: 140, text: '140', type: 'tool' },
        ...
        1000: {
          ...
          awards: [
            ...
            { icon: 'zjs_60_60.png', id: 142, name: '紫晶石', nums: 350, text: '350', type: 'tool' },
            { icon: 'lhq_60_60.png', id: 0, name: '靓号券', nums: 2, text: '2', type: 'pretty_card' }
          ],
          // days_cond: '4',
          days_cond: '5',
        ...
        3000: {
          ...
          awards: [
            ...
            { icon: 'zjs_120_120.png', id: 142, name: '紫晶石', nums: 1300, text: '1300', type: 'tool' },
      ...
      // 天天首充礼
      is_last_day: false, // 是否为最后一天 用于按钮文本显示
      single_recharge_status: {
        condition: 1,
        has_right: 0,
        awards: [
          { type: 'mic', tool_id: 2, icon: '7znts.png', name: '永久头饰', double_nums: 0, nums: 20, show_text: '永久头饰', text: '永久头饰', mark: 'mk2_16.png' },
...
.RechargeRebate {
  position: relative;
  .rechargeAwards {
    width: 728px; /*todo 宽度 去看图片原始宽度，不要看蓝湖*/
    border-image-slice: 110 0 338 0 fill; /*todo 顶部距离是一般tab高度 底部距离一般和outBox一致*/
    border-image-width: 110px 0 338px 0; /*todo 顶部距离是一般tab高度 底部距离一般和outBox一致*/
    border-image-source: url('@/pages/celebration/assets/zs_3.png'); /*todo 连续充值有礼背景*/
    ...
    .RechargeRebate_BottomBox_Tab {
      ...
      .resetIcon {
        ...
        width: 124px;
        height: 42px;
        background: url('@/pages/celebration/assets/mk2_1.png') no-repeat left top/100% 100%; /*todo 图片名 可能要改*/
      }
      .update-1 {
        position: absolute;
        top: 0; /*todo 重置图标 距离tab bottom*/
        left: 290px; /*todo 重置图标 距离tab left*/
        width: 114px;
        height: 104px;
        background: url('@/pages/celebration/assets/mk2_4.png') no-repeat left top/100% 100%; /*todo 图片名 可能要改*/
      }
      .tab {
        position: relative;
        flex: 1;
  ...
  .active-tab-bg {
    border-image-source: url('@/pages/celebration/assets/zs_4.png'); /*todo 连续充值有礼边框背景图片名*/
  }
}
</style>
