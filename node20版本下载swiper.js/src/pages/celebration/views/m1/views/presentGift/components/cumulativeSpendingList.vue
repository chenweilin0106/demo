<template>
  <OutBox class="CumulativeSpendingList" title="mk1_title_8.png">
...
.CumulativeSpendingList {
  .resetIcon {
    z-index: 1;
    top: -5px; /*todo 每日重置图标top 根据容器定位*/
    right: 179px; /*todo 每日重置图标right 根据容器定位*/
    width: 124px; /*todo 宽度*/
    height: auto;
  ...
  .listMain {
    ...
    .taskItem {
      ...
      height: 140px; /*todo 卡片高度 不需要加上外圈描边宽度*/
      border-radius: 14px; /*todo 卡片圆角*/
      .focus-color {
      ...
      .awardItem {
        ...
        .awardText {
          ...
          color: #fff;
          width: 100%;
          background-color: #7954E4; /*todo 奖励文本背景色*/
