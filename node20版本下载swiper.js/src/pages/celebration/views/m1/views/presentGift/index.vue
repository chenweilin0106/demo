<template>
  <div class="PresentGift">
    <CpRewards :cpRewardsData="marriage_gift" @update="marriage_gift.has_right = 2" />
...
<script>
// import GiftUpdate from '@/pages/celebration/views/m1/views/presentGift/components/index.vue' // 礼物焕新
// import RobRewards from '@/pages/celebration/views/presentGift/components/robRewards.vue' // 打劫有礼
import LotteryMarried from '@/pages/celebration/views/m1/views/presentGift/components/lotteryMarried/index.vue' // 抽奖结婚
import LimitDiscount from '@/pages/celebration/views/m1/views/presentGift/components/limitDiscount.vue' // 限时折扣
import CpRewards from '@/pages/celebration/views/m1/views/presentGift/components/cpRewards.vue' // cp贺礼
import CumulativeSpendingList from '@/pages/celebration/views/m1/views/presentGift/components/cumulativeSpendingList' // 累计消费
// import PresentGiftRank from '@/pages/celebration/views/m1/views/presentGift/components/presentGiftRank.vue'
import { getPageData } from '@/api/index'
export default {
  name: 'presentGift',
  // components: { CongratsGetPopup, RobRewards, GiftUpdate, CumulativeSpendingList },
  components: { CumulativeSpendingList, CpRewards, LimitDiscount, LotteryMarried },
  data() {
    return {
      ...
      user_gender: '0', // 性别
      user_icon: '', // 头像
      marriage_gift: { awards: [{ icon: 'ts_gfsh_02.svga', id: 0, name: '真爱永恒', nums: 3, text: '头饰+3天', type: 'mic' }, { icon: 'yb_120_120.png', id: 'gamegold', name: '元宝', nums: 200000, text: '元宝+20万', type: 'property' }], has_right: 0 }, // cp贺礼
      // 消费有礼-----------------
      consume_status: {
