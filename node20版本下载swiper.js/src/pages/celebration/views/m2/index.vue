<template>
  <div class="m2Vue">
    ...
    <div class="tabs_box flex align-center flex-no-wrap position-relative justify-between">
  ...
  data() {
    return {
      tabsArray: Object.freeze([
        { tabName: '烟花大会', to: '/m2/fireWorks', icon: 'mk2_tab1_1.png', actIcon: 'mk2_tab1.png' },
        { tabName: '幸运锦鲤', to: '/m2/luckKoi', icon: 'mk2_tab2_1.png', actIcon: 'mk2_tab2.png' },
        { tabName: '全民砍价', to: '/m2/peopleBargained', icon: 'mk2_tab3_1.png', actIcon: 'mk2_tab3.png' }
      ])
    }
  },
  methods: {
    ...
    track(params) {
      ...
      this.$thinking.track('WebClick', { element: '周年派对', module: tabName }) // 数数点击埋点
