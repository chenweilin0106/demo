    ...
    <van-popup v-model="isShowPo" :close-on-click-overlay="false" @click-overlay="clickClose">
      <div class="popup-content">
        ...
        <div class="main">
          ...
          <div class="textDesc">
            {{ config.text }}&ensp;<i>({{ config.num }}/{{ config.need_num }})</i>
          </div>
...
.content {
  .taskIcon {
    ...
    right: 0;
    top: 450px;
    background: url('@/pages/qingMing/assets/mk4_22.png') no-repeat;
    background-size: 100% 100%;
    &.completed {
      background: url('@/pages/qingMing/assets/mk4_21.png') no-repeat;
      background-size: 100% 100%;
    }
    .taskIconTime {
      font-size: 22px;
  ...
  .popup-content {
    ...
    width: 628px;
    height: 719px;
    background: url('@/pages/qingMing/assets/tk_bg_2.png') no-repeat;
    background-size: 100% 100%;
    padding: 5px;
    pointer-events: auto;
    .title-image {
    ...
    .main {
      ...
      .timeLeft {
        width: 493px;
        height: 68px;
        background: url('@/pages/qingMing/assets/tk_1.png') no-repeat;
        background-size: 100% 100%;
        position: absolute;
        left: 50%;
        transform: translate(-50%);
