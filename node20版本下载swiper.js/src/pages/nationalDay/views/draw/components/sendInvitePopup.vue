...
.friendsArea{
  ...
  .friendsShowItem{
    ...
    .userBtn{
      ...
      transform: translateY(-50%);
      &.yesChoose{
        background: url('@/pages/nationalDay/assets/tk_39.png') no-repeat left top/100% 100%;
      }
      &.noChoose{
        background: url('@/pages/nationalDay/assets/tk_40.png') no-repeat left top/100% 100%;
      }
    }
  }
}
