...
import TasksList from '@/pages/nationalDay/views/pointReward/components/tasksList.vue'
import ExchangeList from '@/pages/nationalDay/views/pointReward/components/exchangeList.vue'
import Jump2024 from '@/pages/nationalDay/views/pointReward/components/jump2024.vue'
const ExchangeGiftsPopup = () => import('@/pages/nationalDay/views/pointReward/popups/exchangeGiftsPopup.vue')
export default {
  name: 'pointReward',
  ...
  data() {
    return {
      ...
      goods_list: [
        ...
        { type: 'title', goods_name: '永久称号', goods_type: 'title', goods_id: 4987, goods_num: 0, price: 600, max_times: 1, goods_icon: 'ch_ryzd', goods_icon_t: 'ch_ryzd', goods_num_text: '永久称号+1', is_owned: false, is_lock: false, exchange_times: 0, has_right: 1 },
        ...
        { exchange_times: 0, goods_icon: 'qp_fhff_sc', goods_icon_t: 'qp_fhff_sc', goods_id: 80, goods_name: '繁花纷纷', goods_num: 3, goods_num_text: '私聊气泡+3天', goods_type: 'chat_bubble', has_right: 1, is_lock: false, is_owned: false, max_times: 2, price: 45, price_text: '45', type: 'chat_bubble' },
      ...
      pointIcon: Object.freeze('qz_73_61.png'), // 道具图标
      pointName: Object.freeze('旗帜') // 道具名称
    }
  },
  computed: {
    taskListData() {
