...
<script>
// import GiftUpdate from '@/pages/nationalDay/views/presentGift/components/giftUpdate.vue' // 礼物焕新
// import RobRewards from '@/pages/nationalDay/views/presentGift/components/robRewards.vue' // 打劫有礼
// import LimitDiscount from '@/pages/nationalDay/views/presentGift/components/limitDiscount.vue' // 限时折扣
// import CpRewards from '@/pages/nationalDay/views/presentGift/components/cpRewards.vue' // cp贺礼
import CumulativeSpendingList from '@/pages/nationalDay/views/presentGift/components/cumulativeSpendingList' // 累计消费
import { getPageData } from '@/api/index'
// import { _throttle } from '@/utils/tool'
// const CongratsGetPopup = () => import('@/pages/nationalDay/components/congratsGetPopup.vue')
export default {
  name: 'presentGift',
