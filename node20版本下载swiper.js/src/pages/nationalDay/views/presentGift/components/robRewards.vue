...
export default {
  name: 'robRewards',
  props: ['masonry_nums', 'masonry_max', 'recharge_nums', 'recharge_max', 'award_list'],
  data() {
    return {
...
.robRewards {
  ...
  .getTitle {
    ...
    .title {
      width: 485px;
      height: 215px;
      background: url('@/pages/nationalDay/assets/mk3_2.png') no-repeat center top/100% 100%;
      .imgCompo {
        margin-left: 166px;
        margin-top: 65px;
        width: 210px;
