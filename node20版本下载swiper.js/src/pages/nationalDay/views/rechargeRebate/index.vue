...
.RechargeRebate {
  ...
  .rechargeAwards {
    ...
    border-image-source: url('@/pages/nationalDay/assets/zs_3.png'); /*todo 连续充值有礼背景*/
    padding-top: 0;
    .RechargeRebate_BottomBox_Tab {
      ...
      .resetIcon {
        ...
        width: 124px;
        height: 42px;
        background: url('@/pages/nationalDay/assets/mk2_1.png') no-repeat left top/100% 100%; /*todo 图片名 可能要改*/
      }
      .update-1 {
        position: absolute;
        ...
        width: 96px;
        height: 128px;
        background: url('@/pages/nationalDay/assets/mk2_5.png') no-repeat left top/100% 100%; /*todo 图片名 可能要改*/
      }
      .tab {
        position: relative;
        flex: 1;
  ...
  .active-tab-bg {
    border-image-source: url('@/pages/nationalDay/assets/zs_4.png'); /*todo 连续充值有礼边框背景图片名*/
  }
}
</style>
