...
const CongratsGetPopup = () => import('@/pages/nationalDay/components/congratsGetPopup.vue') // 恭喜获得弹窗
...
.giftBox {
  ...
  background: url('@/pages/nationalDay/assets/mk2_12.png') no-repeat left top/100% 100%; /*todo 礼盒容器背景*/
