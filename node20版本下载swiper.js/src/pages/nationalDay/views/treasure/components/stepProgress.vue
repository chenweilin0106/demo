...
export default {
  ...
  methods: {
    ...
    nodeIconCk(item) {
      console.log(item)
      if (item.has_right == 1 && this.$emit('judgeSecondDay')) {
  ...
  .psBg{
    ...
    .nodeItem{
      ...
      .itemNodeIcon{
        ...
        &.active{
          ...
          &::after{
            ...
            width: 50px;
            height: 59px;
            background: url('@/pages/nationalDay/assets/mk4_20.png') no-repeat left top/100% 100%;
            position: absolute;
            left: 50%;
            top: 60%;
            transform: translate(-50%, -50%);
      ...
      .rewardDiv{
        width: 128px;
        height: 143px;
        background: url('@/pages/nationalDay/assets/mk4_16.png') no-repeat left top/100% 100%;
        position: absolute;
        left: 50%;
        ...
        &.status1::after{
          ...
          width: 144px;
          height: 157px;
          background: url('@/pages/nationalDay/assets/mk4_18.png') no-repeat left top/100% 100%;
          position: absolute;
          left: -8px;
          top: -8px;
          z-index: 1;
        ...
        &.status2::after{
          ...
          width: 128px;
          height: 143px;
          background: url('@/pages/nationalDay/assets/mk4_17.png') no-repeat left top/100% 100%;
          position: absolute;
          left: 0px;
          top: 0px;
          z-index: 1;
        ...
        .aslc_leftItem_awardIcon{
          width: 32px;
          height: 32px;
          background: url('@/pages/nationalDay/assets/mk4_19.png') no-repeat left top/100% 100%;
          position: absolute;
          right: 0;
          top: -10px;
          z-index: 2;
