<template>
  <out-box class="Single_RechargeGift" title="tt_02.png">
    <!-- 充值说明 -->
    ...
    <!-- 充值按钮 -->
    <div @click="getRechargeGift" :class="['flex-center', 'RechargeRebate_TopBox_Button', ButtonStyle('1', single_recharge_status.has_right)]">
...
export default {
  ...
  computed: {
    ...
    singleRechargeAwardIcon() {
      return (type) => {
        return type === 'property' ? 'yb_120_120.png' : type === 'tool' ? 'ljs_120_120.png' : 'lmdc_141_116.png'
      }
    },
    // 充值礼包道具名称
