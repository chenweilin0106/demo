    ...
    <div class="popupOverly position-fixed flex align-end justify-center" @click.self="clickClose" @touchmove.prevent.stop>
      <div class="popupContent" @touchmove.prevent.stop>
        <div class="paymentWay flex align-center justify-center">
          <div class="wxPayWay flex align-center justify-center line-height-100" :class="{ currntPayment: payType === 'wx' }" @click="payType = 'wx'">
            <img :src="IconPath('wechatpay_01.png')" />微信支付
          </div>
          <div
            class="aliPayWay flex align-center justify-center line-height-100"
            :class="{ currntPayment: payType === 'alipay' }"
