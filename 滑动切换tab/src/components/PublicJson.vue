<template>
  <div class="jsonContainer position-relative w-100 h-100 flex align-center justify-center">
    <!-- 用户头像 -->
    <div class="avatarContainer position-absolute flex align-center justify-center w-100 h-100" v-if="userAvatar">
      <img :src="userAvatar" class="w-100 h-100 fit-cover radius-50" />
    </div>
    <!-- json容器 -->
    <div v-if="jsonName" class="animateContainer flex align-center justify-center w-100 h-100" :class="'PublicJson_' + jsonName" :id="JsonId" />
  </div>
</template>
