...
import PetIcon from '../../petparty/components/pet/petIcon.vue'

export default {
  name: 'rankCom1', // 图鉴榜 宠物头像 无昵称显隐 示例：20260212情人节活动
  components: { PetIcon },
  props: {
  ...
  .topArea {
    ...
    .topItem {
      ...
      &.topItem_1{
        ...
        width: 266px;
        height: 482px;
        background-image: url('@/assets/mk6_23_1.png');
        .topItemAvatarBorder{
          z-index: 1;
          top: -94px;
          width: 408px;
      ...
      &.topItem_2{
        ...
        width: 266px;
        height: 482px;
        background-image: url('@/assets/mk6_25_1.png');
        .topItemAvatarBorder{
          z-index: 1;
          top: -94px;
          width: 408px;
      ...
      &.topItem_3{
        ...
        width: 266px;
        height: 482px;
        background-image: url('@/assets/mk6_27_1.png');
        .topItemAvatarBorder{
          z-index: 1;
          top: -94px;
          width: 408px;
