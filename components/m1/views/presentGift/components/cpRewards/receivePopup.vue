<template>
  <PopupBox title="恭喜获得" class="receivePopup" size="1" is-son @clickClose="clickClose">
...
export default {
  ...
  methods: {
    formatName(info) {
      if (info.id === 'gamegold') return `+${info.nums}`
