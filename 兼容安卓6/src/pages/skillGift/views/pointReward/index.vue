  ...
  <div class="rewardRedemption">
      ...
      <div class="border_box">
        ...
        <div class="white_border">
          ...
          >
            <div class="top_item_left">
              <div class="img-box">
                ...
                <div class="img-bottom">积分+{{ item.award_nums }}</div>
              </div>
              <div class="text-box">
                <p>{{ item.task_name }}</p>
                <p>
          ...
          <div class="top-text">
            <ul>
              <li>
                <span></span>活动期间完成以上每日任务可领取积分<img
    ...
    <div class="theme_box theme-bottom-box">
      ...
      <div class="border_box">
        <div class="white_border">
          <!-- 我的道具 -->
          <div class="theme_present bottom-top">
            我的积分<img src="../../assets/mk1_1_1.png" alt="" />：{{
              dataList.my_goods
            }}
          </div>
          <!-- 兑换项-->
            ...
            >
              ...
              <div class="text-box">
                <p v-if="item.type === 'lucky_key'">
                  消耗<span>{{ item.price }}个积分</span>兑换 第二个<span
                    >半价</span
                  >
                </p>
                <p v-else>
                ...
                <p v-else>
                  限兑：{{ item.exchange_times }}/{{ item.max_times }}
                </p>
              </div>
              <div
                class="button-box"
    ...
    >
      ...
      <div class="white_border">
        <p v-if="true">
          剩余积分<img src="../../assets/mk1_1_1.png" alt="" /> ：{{ my_goods }}
        </p>
        <div
          class="img-box"
          v-if="true"
        ...
        >
          <div class="left-button" @click="onExcharge(1)">
            <p>
              {{ goods_detail.type === 'lucky_key' ? '兑1个' : '兑换' }}
            </p>
            <p v-if="goods_detail.type === 'lucky_key'">
              (消耗：<img src="../../assets/mk1_1_1.png" alt="" />
              {{
...
export default {
    ...
    return {
      ...
      dataList: {
        goods_list: [
          ...
          {
            exchange_times: 0,
            goods_icon: 'tk_dj_6_1@1x.png',
            goods_icon_t: 'tk_dj_6.png',
            goods_id: 5,
            goods_name: '口香糖',
            goods_num: 0,
  ...
  async created() {
    ...
    await this.getPointRewardData()
    this.$nextTick(() => {
      // svgFun(0, cszdrw, 'cszdrw', '.rewardRedemptionLottie')
      svgFun(1, hql, 'hql', '.rewardRedemptionLottie')
    })
  },
  mounted() {},
  methods: {
    ...
    async onButtomClick(flag, type) {
      if (flag == 1) {
        ...
        this.$nextTick(() => {
          if (goodsType === 'mic') {
            this.tkLottie = svgFun(0, hql, 'hql', '.rewardRedemption_tk_lottie')
          }
          // if (goodsType === 'title') {
