...
.returnCourteous-page {
  .depositRebate-bottom-body {
    ...
    .last-item-box {
      width: 332px;
      background: linear-gradient(90deg, #3273ff, #4277ef);
      box-shadow: 0px 3px 0px 0px #b6ccf8;
      border-radius: 6px;
      display: flex;
      ...
      .bottom-item-button-unDid {
        background: linear-gradient(0deg, #bfddff, #ffffff) !important;
        color: #5755ea !important;
      }
    }
  }
  // 底部文字
