...
.depositRebate-bottom-item {
  ...
  // box-shadow: 0px 3px 0px 0px #a2cbf1;
  // border-radius: 6px;
  display: flex;
  ...
  //   background: linear-gradient(0deg, #e99b13, #f9e16e) !important;
  //   color: #fff !important;
  // }
  // // 已领取
  // .bottom-item-button-done {
  //   background: linear-gradient(0deg, #989898, #dddddd) !important;
  //   color: #fff !important;
  // }
}
</style>
