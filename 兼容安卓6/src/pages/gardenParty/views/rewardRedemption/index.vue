<template>
  <div class="rewardRedemption">
    <div class="theme_box theme-top-box">
      ...
      <div class="white_border">
        ...
        >
          <div class="top_item_left">
            <div class="img-box">
              ...
              <div class="img-bottom">桃花+{{ item.award_nums }}</div>
            </div>
            <div class="text-box">
              <p>{{ item.task_name }}</p>
              <p>
        ...
        <div class="top-text">
          <ul>
            <li>
              <span></span>活动期间完成以上每日任务可领取桃花<img
    ...
    <div class="theme_box theme-bottom-box">
      ...
      <div class="white_border">
        ...
        <div class="bottom-top">
          我的桃花<img src="../../assets/mk1_1_1.png" alt="" />：{{
            dataList.my_goods
          }}
        </div>
        <!-- 兑换项-->
          ...
          >
            ...
            <div class="text-box">
              <p v-if="item.type === 'lucky_key'">
                消耗<span>{{ item.price }}个桃花</span>兑换 第二个<span
                  >半价</span
                >
              </p>
              <p v-else>
                消耗<span>{{ item.price }}个桃花</span>兑换
              </p>
    ...
    >
      ...
      <div class="white_border">
        <p v-if="true">
          剩余桃花<img src="../../assets/mk1_1_1.png" alt="" /> ：{{ my_goods }}
        </p>
        <div
          class="img-box"
          v-if="true"
        ...
        <p v-if="goods_detail.type === 'lucky_key'">
          首个消耗50个<img src="../../assets/mk1_1_1.png" alt="" />第二个半价
        </p>
        <!-- 计数器盒子 -->
        <div
          class="counter-box"
...
import yywg from "../../assets/lottie/yywg/data.json";
import wwms from "../../assets/lottie/wwms/data.json";
export default {
  // 奖励兑换
  ...
  async created() {
    ...
    this.$nextTick(() => {
      svgFun(0, wwms, "wwms", ".rewardRedemptionLottie");
      svgFun(1, yywg, "yywg", ".rewardRedemptionLottie");
    });
  },
  mounted() {},
  methods: {
